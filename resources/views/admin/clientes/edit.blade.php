    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.clientes.update", [$cliente->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nit') ? 'is-invalid' : '' }}" type="text" name="nit" id="nit" value="{{ old('nit', $cliente->nit) }}" required>
                @if($errors->has('nit'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre_empresa') ? 'is-invalid' : '' }}" type="text" name="nombre_empresa" id="nombre_empresa" value="{{ old('nombre_empresa', $cliente->nombre_empresa) }}" required>
